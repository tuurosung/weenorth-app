                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="last_name" id="edit_last_name"
                                    placeholder="Enter last name" value="{{ $member->last_name }}" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="cohort" id="edit_cohort"
                                    placeholder="e.g. 2024-A" value="{{ $member->cohort }}" />
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="district_id" id="edit_district_id">
                                    ...
                                    @foreach($districts as $district)
                                        <option value="{{ $district->id }}" {{ $member->district_id == $district->id ? 'selected' : '' }}>
                                            {{ $district->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="trade_id" id="edit_trade_id">
                                    ...
                                    @foreach($trades as $trade)
                                        <option value="{{ $trade->id }}" {{ $member->trade_id == $trade->id ? 'selected' : '' }}>
                                            {{ $trade->trade_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="skill_level" id="edit_skill_level">
                                    ...
                                    <option value="beginner" {{ $member->skill_level === 'beginner' ? 'selected' : '' }}>Beginner</option>
                                    <option value="intermediate" {{ $member->skill_level === 'intermediate' ? 'selected' : '' }}>Intermediate</option>
                                    <option value="advanced" {{ $member->skill_level === 'advanced' ? 'selected' : '' }}>Advanced</option>
                                    <option value="expert" {{ $member->skill_level === 'expert' ? 'selected' : '' }}>Expert</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="membership_type" id="edit_membership_type" required>
                                    ...
                                    <option value="individual" {{ $member->membership_type === 'individual' ? 'selected' : '' }}>Individual</option>
                                    <option value="corporate" {{ $member->membership_type === 'corporate' ? 'selected' : '' }}>Corporate</option>
