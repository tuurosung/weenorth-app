...
<x-headers.top-header2 title="Region Details">
...
<div>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="d-flex flex-column h-100">
                                            <div class="hstack gap-3 mb-5">
                                                ...
                                                <h3 class="text-white fs-8 mb-0 text-nowrap">{{ $region->region_name }}
                                                </h3>
                                            </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="triggerId">
                                            <a href="javascript:void(0);"
                                                class="dropdown-item d-flex make-regional-executive"
                                                data-url="{{ route('network.make-regional-executive') }}"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm datatables">
                            ...
                            <tbody>
                                @foreach ($region->executives as $executive)
                                <tr class="">
    ...
    @endsection
    @push('scripts')
    @vite(['resources/js/modules/regions/show-regions.js'])
    @endpush
