<div class="modal fade" id="editServiceCenterModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('service-center.update', $serviceCenter) }}">
                @csrf
                @method('PATCH')
                <div class="modal-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="location" id="edit_location"
                                    placeholder="e.g. Wa Central Service Center" value="{{ $serviceCenter->location }}"
                                    required />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="center_representative"
                                    id="edit_center_representative" placeholder="e.g. John Doe"
                                    value="{{ $serviceCenter->center_representative }}" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="opening_hours" id="edit_opening_hours"
                            ...
                            value="{{ $serviceCenter->opening_hours }}" />
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Update Service Center</button>
                </div>
            </form>
        </div>
    </div>
