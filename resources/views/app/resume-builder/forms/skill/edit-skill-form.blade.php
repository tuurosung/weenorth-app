<div class="form-group">
    ...
    <input type="text" class="form-control" name="skill_description" id="skill_description" value="{{ $skill->skill_description ?? '' }}"
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-select select2-input" name="experience_level" id="experience_level" required>
                ...
                <option value="{{ $experience }}" {{ $skill->experience_level === $experience ? 'selected' : '' }}>{{ $experience }}</option>
                @endforeach
            </select>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-select select2-input" name="years_of_experience" id="years_of_experience" required>
                ...
                <option value="{{ $yearsOfExperience }}" {{ $skill->years_of_experience === $yearsOfExperience ? 'selected' : '' }}>{{ $yearsOfExperience }}</option>
                @endforeach
            </select>
        </div>
